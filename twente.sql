...
(1, 3, 'Mark Barney weet na zijn vakantie zijn wachtwoord niet meer.', 'Wachtwoord vergeten', 1, 6, 1, 'Niet van toepassing', 'Wachtwoord gereset naar standaard waarden. Optie Change password at next logon aagezet.', 'Gebruiker gebeld met nieuw tijdelijk wachtwoord.', '2019-12-02 15:32:00', 1),
(2, 2, 'Bestand staat niet meer in de map van het project. Bestand is vorige week dinsdag voor het laatst aangevuld en opgeslagen.', 'Bestand met planning van project is weg.', 2, 60, 1, 'Bestand gewist', 'Bestand teruggehaald van restore.', 'Gemeld dat bestand terug staat.', '2019-12-02 15:32:00', 1),
...
(4, 4, 'Gebruiker wil een pagina in een Word document landscape afdrukken. Pagina\'s voor en na deze pagina dienen portrait te blijven.', 'Secties in Word', 1, 30, 1, 'Secties gebruiken', 'Met gebruiker meegekeken. de werking van secties uitgelegd en samen ingesteld voor het document.', 'Niet van toepassing.', '2019-12-02 15:32:00', 1),
(5, 3, 'Als laptop opstart alleen drie piepjes te horen. Laptop doet verder niets.', 'Piepjes bij aanzetten laptop', 1, 90, 1, 'Geheugen vervangen', 'Geheugen blijkt defect. Geheugen vervangen. Geheugen wordt RMA gestuurd.', 'Gebruiker heeft laptop direct meegenomen.', '2019-12-02 15:32:00', 2),
(6, 7, 'Gebruiker wilt zakeljke e-mail op priv&eacute;tablet', 'E-mail op priv&eacute;tablet', 1, 15, 1, 'Standaard instellingen', 'Telefonisch samen met de gebruiker tablet ingesteld.', 'Niet van toepassing.', '2019-12-03 15:32:00', 1),
(7, 7, 'Laptop is gevallen. Er zit nu een breuk in scherm.', 'Breuk in laptopscherm', 1, 90, 1, 'Tijdelijk andere laptop', 'Data overgezet naar tijdelijke laptop. Deze laptop wordt opgestuurd naar leverancier voor reparatie.', 'Aan gebruiker gemeld dat nieuwe laptop opgehaald kan worden.', '2019-12-03 15:32:00', 2),
...
(12, 6, 'Pc is traag. Ook nadat door ICT-afdeling een nieuwe image geïnstalleerd is.', 'Pc reageert heel traag ook na herstarten', 1, 120, 1, 'BIOS-instellingen goed zetten', 'Na draaien van performace tool bleken BIOS-instellingen geheugen niet goed te staan.', 'Gebruiker laptop terug gegeven.', '2019-12-05 15:32:00', 2),
(13, 3, 'Gebruiker is het wachtwoord van priv&eacute;laptop vergeten. Graag wachtwoord verwijderen of instellen op ander wachtwoord.', 'Lokaal wachtwoord kwijt', 1, 90, 1, 'Wachtwoord teruggezocht', 'Met behulp van tool Windows wachtwoord achterhaald.', 'Wachtwoord telefonisch aan gebruiker doorgegeven.', '2019-12-05 15:32:00', 1),
(14, 6, 'Bij opstarten internetbrowser worden advertenties getoond. Bij wegklikken komen er steeds meer advertenties.', 'Vreemde pagina\'s op internet', 1, 60, 1, 'Malware verwijderd', 'Malware van laptop verwijderd.', 'Gebruiker gemeld en komt laptop weer ophalen.', '2019-12-05 15:32:00', 1),
...
(16, 1, 'Buitendienstmedewerkers hebben geen toegang meer tot het netwerk.', 'Geen VPN-toegang', 40, 240, 1, 'Interface in router defect', 'WAN-interface van router die werkt als VPN-server defect. Reservekaart geplaatst. opnieuw geconfigureerd en getest.', 'Alle buitendienstmedewerkers gemaild.', '2019-12-06 15:32:00', 1),
(17, 3, 'Er is een nieuwe medewerkster aangenomen voor projectplanning. Haar naam is Fee Willemse. Ze begint volgende week maandag. Graag account aanmaken met dezelfde rechten als die van haar collega Sigrid van der Wiel.', 'Nieuwe medewerker op projectplanning', 1, 15, 3, 'Niet van toepassing', 'Gebruiker is aangemaakt.', 'Mail met login gegevens verzonden aan hoofd van afdeling.', '2019-12-02 15:32:00', 1),
...
(20, 3, 'Sarisa de Hoogt weet na vakantie haar wachtwoord niet meer.', 'Wachtwoord vergeten', 1, 6, 3, 'Niet van toepassing', 'Wachtwoord gereset naar standaard waarden. Optie Change password at next logon aagezet.', 'Gebruiker gebeld met nieuw tijdelijk wachtwoord.', '2019-12-02 15:32:00', 1),
...
(22, 6, 'Printer geeft melding \"Engine Error please contact administrator\". Gebruikers printen nu op printer van financiële administratie.', 'Papier zit vast in printer', 15, 15, 4, 'Tandwiel defect', 'Bij leverancier aangemeld; wordt binnen 4 werkdagen vervangen.', 'Gebruikers gemaild dat de printer binnen 4 werkdagen gerepareerd wordt door de leverancier.', '2019-12-03 15:32:00', 2),
(23, 6, 'Op alle kantoorwerkplekken verschijnt dagelijks meerdere malen de melding dat JAVA geupdate moet worden.', 'Java updatemelding', 40, 120, 3, 'oude versie van JAVA was ge&iuml;stalleerd', 'Via AD nieuwe versie van JAVA uitgerold.', 'Niet direct teruggemeld aan gebruikers.', '2019-12-03 15:32:00', 1),
(24, 6, 'Het benaderen van data vanaf de servers en vanaf het internet is traag. Het gaat wel. maar heel langzaam.', 'Netwerk is traag bij financiele administratie', 4, 180, 3, 'Configuratiefout in switch', 'Alle poorten op 1000 mbps full duplex gezet.', 'Oplossing aan afdelingshoofd gemeld.', '2019-12-03 15:32:00', 2),
...
(26, 7, 'Evert de Vrind. een medewerker van de CAD-afdeling. is op staande voet ontslagen. Zijn account moet per direct afgelosten worden.', 'Ontslagen medewerker CAD-afdeling', 1, 15, 3, 'Account disabelen', 'Account gedisabeld.', 'Aan HRM doorgegeven dat account uitstaat.', '2019-12-04 15:32:00', 1),
(27, 7, 'Werkplek van secretariaat moet omgezet worden naar de afdeling HRM.', 'Verhuizen werkplek', 1, 120, 3, 'Niet van toepassing', 'Desktop verhuisd. nieuwe patch gemaakt en oude verwijderd. Patch documentatie is bijgewerkt.', 'Gebruiker ging direct op nieuwe plaats aan het werk.', '2019-12-04 15:32:00', 2),
...
(29, 1, 'Netwerk lijkt in zijn geheel niet meer te werken. ', 'Netwerk plat. ', 80, 150, 3, 'Patchfout', 'Patchfout heeft netwerkloop veroorzaakt.', 'Gemeld aan secretariaat. Die verzorgen communicatie naar rest van het bedrijf.', '2019-12-05 15:32:00', 1),
(30, 2, 'In verband met defecte printer wilt gebruiker dat prints automatisch uit de printer van HRM komen.', 'Standaard printer', 1, 15, 3, 'Andere standaard printer', 'Remote HRM printer ingesteld als standaard.', 'Niet van toepassing', '2019-12-05 15:32:00', 2),
...
(32, 6, 'Bij opstarten internetbrowser worden advertenties getoond. Bij weg klikken komen er steeds meer advertenties.', 'Vreemde pagina\'s op internet', 1, 60, 3, 'Malware verwijderd.', 'Malware van laptop verwijderd.', 'Gebruiker gemeld en komt laptop weer ophalen.', '2019-12-06 15:32:00', 1),
(33, 3, 'Is het wachtwoord van priv&eacute;laptop vergeten. Graag wachtwoord verwijderen of instellen op ander wachtwoord.', 'Lokaal wachtwoord kwijt', 1, 90, 3, 'Wachtwoord terug gezocht.', 'Met behulp van tool Windows wachtwoord achterhaald.', 'Wachtwoord telefonisch aan gebruiker doorgegeven.', '2019-12-06 15:32:00', 1);
